						...
						<ul class="tree treeFolder">
							<li><a href="">数据源选择</a>
								<ul>
									...
									<li><a href="${BaseURL}datasource" target="navTab"
										rel="datasource">数据源选择</a></li>
								...
								<ul>
									<li><a href="">Apriori</a>
										<ul>
											...
											<li><a href="${BaseURL}associations/para" target="navTab"
												rel="associationspara">参数选择</a></li>
											<li><a href="${BaseURL}associations/run" target="navTab"
							...
							<li><a href="">分类</a>
								<ul>
									...
									<li><a href="">IncrementalBayes</a>
										<ul>

											<li><a href="${BaseURL}incrementalbayes/para" target="navTab"
												rel="incrementalbayespara">参数选择</a></li>
											<li><a href="${BaseURL}incrementalbayes/run" target="navTab"
												rel="incrementalbayesrun">开始分析</a></li>
										</ul></li>

									<li><a href="">NaiveBayes</a>
										<ul>

											<li><a href="${BaseURL}naivebayes/para" target="navTab"
												rel="naivebayespara">参数选择</a></li>
											<li><a href="${BaseURL}naivebayes/run" target="navTab"
									...
									<li><a href="">J48</a>
										<ul>
											...
											<li><a href="${BaseURL}j48/para" target="navTab" rel="j48para">参数选择</a></li>
											<li><a href="${BaseURL}j48/run" target="navTab" rel="j48run">开始分析</a></li>
										</ul></li>

									<li><a href="">SMO</a>
										<ul>

											<li><a href="${BaseURL}smo/para" target="navTab" rel="smopara">参数选择</a></li>
											<li><a href="${BaseURL}smo/run" target="navTab" rel="smorun">开始分析</a></li>
										</ul></li>
								...
								<ul>
									<li><a href="">KMeams</a>
										<ul>
											...
											<li><a href="${BaseURL}kmeans/para" target="navTab"
												rel="kmeanspara">参数选择</a></li>

											<li><a href="${BaseURL}kmeans/run" target="navTab"
